...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cx("h-30 tale-illustration", className)} style={{ width: '5.9375rem' }}>
            <svg viewBox="0 0 152 120" fill="none" className={cx("tale-illustration__svg", svgClassName)} style={{ width: "100%", height: "100%" }}>
                <circle cx="76" cy="52" r="52" style={{ fill: 'var(--neutral-5)' }} />

                <circle cx="21" cy="19" r="5" style={{ fill: 'var(--neutral-5)' }} />
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("h-32 w-43 tale-illustration", className)} style={{  }}>
            <svg viewBox="0 0 182 137" fill="none" className={cx("tale-illustration__svg", svgClassName)} style={{ width: "100%", height: "100%" }}>
                <circle cx="91" cy="64" r="64" style={{ fill: 'var(--neutral-5)' }} />

                <circle cx="25" cy="20" r="6" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="22" cy="112" r="8" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="165" cy="36" r="8" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="154" cy="9" r="5" style={{ fill: 'var(--neutral-5)' }} />
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cx("h-40 w-55 tale-illustration", className)} style={{  }}>
            <svg viewBox="0 0 220 160" fill="none" className={cx("tale-illustration__svg", svgClassName)} style={{ width: "100%", height: "100%" }}>
                <circle cx="110" cy="80" r="80" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="26" cy="20" r="8" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="198" cy="126" r="6" style={{ fill: 'var(--neutral-5)' }} />
...
export function CloudIllustration({ size = "lg", ...otherProps }: IllustrationProps) {
