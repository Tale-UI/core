    ...
    return (
        <div {...otherProps} className={cx("h-29.5 tale-illustration", className)} style={{ width: '9.5rem' }}>
            <svg viewBox="0 0 152 118" fill="none" className={cx("tale-illustration__svg", svgClassName)} style={{ width: "100%", height: "100%" }}>
                ...
                <circle cx="145" cy="35" r="7" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="134" cy="8" r="4" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="76" cy="52" r="52" style={{ fill: 'var(--neutral-5)' }} />
                <g filter="url(#credit-card-shadow-sm)">
                    ...
                    />
                    <circle cx="114.667" cy="32.3335" r="8.33333" style={{ fill: 'var(--neutral-22)' }} />
                    <circle cx="104.667" cy="32.3333" r="8.33333" style={{ fill: 'var(--neutral-14)' }} />
                    <path
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("h-35.75 w-45 tale-illustration", className)} style={{  }}>
            <svg viewBox="0 0 180 143" fill="none" className={cx("tale-illustration__svg", svgClassName)} style={{ width: "100%", height: "100%" }}>
                <circle cx="90" cy="64" r="64" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="24" cy="6" r="6" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="21" cy="112" r="8" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="164" cy="36" r="8" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="153" cy="9" r="5" style={{ fill: 'var(--neutral-5)' }} />
                <g filter="url(#credit-card-shadow-md)">
                    ...
                    <path
                        ...
                        style={{ fill: 'var(--neutral-14)' }}
                    />
                    <circle cx="137" cy="42" r="10" style={{ fill: 'var(--neutral-22)' }} />
                    <circle cx="125" cy="42" r="10" style={{ fill: 'var(--neutral-14)' }} />
                    <path
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cx("h-41.75 w-55 tale-illustration", className)} style={{  }}>
            <svg viewBox="0 0 220 167" fill="none" className={cx("tale-illustration__svg", svgClassName)} style={{ width: "100%", height: "100%" }}>
                <circle cx="110" cy="80" r="80" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="18" cy="12" r="8" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="198" cy="142" r="6" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="25" cy="138" r="10" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="210" cy="46" r="10" style={{ fill: 'var(--neutral-5)' }} />
                <circle cx="191" cy="11" r="7" style={{ fill: 'var(--neutral-5)' }} />
                <g filter="url(#credit-card-shadow-lg)">
                    ...
                    <path
                        ...
                        style={{ fill: 'var(--neutral-14)' }}
                    />
                    <circle cx="166.837" cy="53.4419" r="12.093" style={{ fill: 'var(--neutral-22)' }} />
                    <circle cx="152.325" cy="53.4419" r="12.093" style={{ fill: 'var(--neutral-14)' }} />
                    <path
...
export function CreditCardIllustration({ size = "lg", ...otherProps }: IllustrationProps) {
