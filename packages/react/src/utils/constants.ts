...
export { EMPTY_OBJECT, EMPTY_ARRAY } from '@tale-ui/utils/empty';
export const CLICK_TRIGGER_IDENTIFIER = 'data-tale-ui-click-trigger';
export const TALE_UI_SWIPE_IGNORE_ATTRIBUTE = 'data-tale-ui-swipe-ignore';
export const LEGACY_SWIPE_IGNORE_ATTRIBUTE = 'data-swipe-ignore';

export const TALE_UI_SWIPE_IGNORE_SELECTOR = `[${TALE_UI_SWIPE_IGNORE_ATTRIBUTE}]`;
