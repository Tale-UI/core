...
export interface CSPProviderProps {
  ...
  /**
   * Whether inline `<style>` elements created by Tale UI components should not be rendered. Instead, components must specify the CSS styles via custom class names or other methods.
   * @default false
   */
