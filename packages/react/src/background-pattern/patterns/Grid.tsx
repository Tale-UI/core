...
const lg = (props: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg width="768" height="768" viewBox="0 0 768 768" fill="none" {...props} className={cx('tale-background-pattern', props.className)}>
...
const md = (props: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg width="480" height="480" viewBox="0 0 480 480" {...props} fill="none" className={cx('tale-background-pattern', props.className)}>
...
const sm = (props: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg width="336" height="336" viewBox="0 0 336 336" {...props} fill="none" className={cx('tale-background-pattern', props.className)}>
...
export function Grid(props: Omit<React.SVGProps<SVGSVGElement>, "size"> & { size?: "sm" | "md" | "lg" }) {
    const { size = "lg", ...svgProps } = props;
    const Pattern = sizes[size];
    return <Pattern {...svgProps} />;
}
