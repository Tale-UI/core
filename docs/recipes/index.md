...
| Recipe | Components Used | Description |
| ------ | -------------- | ----------- |
| [Data Table with Sorting](data-table-with-sorting.md) | Table, Button, IconButton, Menu, Pagination | Sortable data table with row actions and pagination |
...
| [Sidebar — Dual Tier](sidebar-dual-tier.md) | Sidebar, Tooltip | Slim icon rail + secondary label panel on hover |
| [Sidebar — Slim (Icon Only)](sidebar-slim.md) | Sidebar, Tooltip | Permanent icon-only sidebar with tooltips |
...
| [Sidebar Navigation](sidebar-navigation.md) | NavigationMenu, Drawer, IconButton, Separator | Responsive sidebar with mobile drawer (NavigationMenu) |
| [Sidebar with Header](sidebar-with-header.md) | NavigationMenu, Drawer, IconButton, Button, Separator | Two-region layout: fixed sidebar + top header |
...
| [Header Navigation](header-navigation.md) | NavigationMenu, Button, IconButton, Separator | Horizontal nav bar with logo and actions (NavigationMenu) |
...
| Recipe | Components Used | Description |
| ------ | -------------- | ----------- |
| [Dropdown — Icon Button (Simple)](dropdown-icon-simple.md) | Menu, IconButton, Icon | Three-dot ellipsis dropdown for row-level actions |
| [Dropdown — Icon Button (Advanced)](dropdown-icon-advanced.md) | Menu, IconButton, Icon | Ellipsis dropdown with groups, icons, and a submenu |
